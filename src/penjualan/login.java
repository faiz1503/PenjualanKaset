...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnproses.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 102, 0)));
        ...
        jButton2.setText("Tidak Mempunyai Akun? Daftar Sekarang");
    ...
    private void btnprosesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprosesActionPerformed
        ...
        try {
            ...
            if (result.next()) {
                JOptionPane.showMessageDialog(this, "Selamat Datang, " + txtusername.getText() + "","Informasi",JOptionPane.INFORMATION_MESSAGE);
